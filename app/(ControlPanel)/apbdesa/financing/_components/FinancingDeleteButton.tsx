...
import { deleteFinancing } from '../_lib/financing.actions';
// import { deleteExpense } from '../../_lib/expense.actions';

export default function FinancingDeleteButton({ id }: { id: number }) {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      await toast.promise(deleteFinancing(id), {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Tindakan ini tidak dapat dibatalkan. Pembiayaan ini akan{' '}
